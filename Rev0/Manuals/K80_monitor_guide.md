# K80 Monitor V0.4 Manual
### Introduction
K80Mon is the monitor program for K80. It resides in the EPROM, W27C512, and is executed by Z80 immediately after reset. K80 first copies itself to 0xB000-0xBFFF and then jumps to 0xB400 where it signs on, waits for the CF disk to be ready and then displays a command prompt for user inputs.
...
CP/M 2.2 for K80 Rev0.3 JumpTbl+IOByte 7/3/19
